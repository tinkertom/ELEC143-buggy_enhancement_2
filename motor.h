...
// Compares the current state of the motor with the previous state, and return 'true' if a full pulse sequence has been detected. Requires direction and invertion to know which direction to read the motor in.
